...
public class starter extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.supersupro", "com.htetznaing.supersupro.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.supersupro.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public com.htetznaing.supersupro.main _main = null;
